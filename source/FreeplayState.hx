...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if PRELOAD_ALL
		var leText:String = "Press SPACE to preview the Song / Press CTRL to basically cheat. / Press RESET to Reset the song.";
		var size:Int = 16;
		#else
		var leText:String = "Press CTRL to basically cheat. / Press RESET to Reset the song.";
		var size:Int = 18;
		#end
